...
import { DollarSign, Package, ShoppingCart, Trash2, Truck, FileBarChart, ArrowRight } from "lucide-react";

const REPORTS = [
  { name: "Stock Valuation", description: "System qty vs last count with RM values — expected vs real inventory", icon: Package, color: "bg-blue-50 text-blue-600", href: "/admin/reports/stock-valuation" },
