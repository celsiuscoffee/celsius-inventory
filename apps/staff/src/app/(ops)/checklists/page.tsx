...
export default function ChecklistsPage() {
  ...
  const queryUrl = me?.outletId
    ? `/api/checklists?date=${today}&outletId=${me.outletId}`
    : null;
  ...
  useEffect(() => {
    if (checklists && checklists.length === 0 && me?.outletId && !autoGenerated && !isLoading) {
  ...
  }, [checklists, me, autoGenerated, isLoading, today, mutate]);
  ...
  return (
    <div className="px-4 py-4">
      <div className="space-y-4">
        ...
        {/* Empty state — no SOPs scheduled for today at this outlet */}
        {!isLoading && !generating && (!checklists || checklists.length === 0) && (
          <Card className="px-4 py-8 text-center">
            ...
            <p className="mt-1 text-xs text-gray-400">Nothing scheduled for this outlet</p>
          </Card>
        )}
